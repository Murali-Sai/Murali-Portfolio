...
export const experience = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Audited Redis usage across all 6 backend microservices, identifying services that registered Redis but never actually used it, in support of a proposal to replace a fully custom JWT/BCrypt authentication system.",
      "Documented Microsoft Entra ID app registration and custom role setup guides used to configure authentication and 6 application roles across the development environment, supporting a proposed identity migration.",
    ],
    stack: [".NET 8", "C#", "Azure Functions", "Azure", "Entra ID", "MySQL", "Redis", "ReactJS", "TypeScript"],
  },
  {
...
export const projects = [
  {
    ...
    highlights: [
      ...
      "Routes edge cases to human reviewers under a full audit trail, escalating across 4 severity levels (Notify, Approve Action, Approve Plan, Take Over) on low confidence, repeated failures, sensitive operations, or low review scores, with an approval queue that survives API restarts via Supabase.",
      ...
      "Instruments the whole run as OpenTelemetry spans (an agent_task root over llm_call and tool.* children) exported to OTLP or Jaeger, alongside a Streamlit trace explorer with per-task token and cost tracking, validated by 106 of 113 passing tests against a live deployment, covering routing, the rework loop, escalation, memory scoring, and the HTTP API.",
    ],
